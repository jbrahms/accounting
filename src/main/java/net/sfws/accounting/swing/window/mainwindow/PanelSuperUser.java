...
public class PanelSuperUser extends JPanel {
    
    // serial
    private static final long serialVersionUID = 5851562681276716998L;
    
    // panel-name
    private final static String PANEL_DATABASE = "DATABASE";
     ...
     * Create the panel.
     */
    public PanelSuperUser(Object parent) {
    ...
    private void initPanel() {
        ...
        // add label to panel1
        this.lblLabel1 = new JLabel("Super-Administration");
        ...
        this.panel2.setLayout(new MigLayout("", "[300!][grow]", "[grow][]"));
        ...
        tree.setModel(new DefaultTreeModel(
            new DefaultMutableTreeNode("Database") {
                private static final long serialVersionUID = 4593829806574695387L;

                {
                    DefaultMutableTreeNode node_1;
                    DefaultMutableTreeNode node_2;
                    node_1 = new DefaultMutableTreeNode("SF Web Solution");
                        node_2 = new DefaultMutableTreeNode("Group #1");
                            node_2.add(new DefaultMutableTreeNode("Brahms, Jay (JBRAHMS) [A]"));
                            node_2.add(new DefaultMutableTreeNode("Oliver, Charles (COLIVER)"));
                        node_1.add(node_2);
                        node_2 = new DefaultMutableTreeNode("Group #2");
                            node_2.add(new DefaultMutableTreeNode("SF Web Solution (SFWSOLUTIO) [A]"));
                    node_1.add(node_2);
                    add(node_1);
                    node_1 = new DefaultMutableTreeNode("Company #2");
                        node_2 = new DefaultMutableTreeNode("Group #2");
                            node_2.add(new DefaultMutableTreeNode("Kleinebrahm, Brigitte (BKLEINEBRA) [A]"));
                        node_1.add(node_2);
                        node_2 = new DefaultMutableTreeNode("Group #4");
                            node_2.add(new DefaultMutableTreeNode("Administrator #4"));
                        node_1.add(node_2);
                    add(node_1);
                    node_1 = new DefaultMutableTreeNode("Company #3");
                        node_2 = new DefaultMutableTreeNode("Group #5");
                            node_2.add(new DefaultMutableTreeNode("Administrator #5"));
                        node_1.add(node_2);
                    add(node_1);
                }
            }
        ...
        // create panels
        this.panelDatabase = new PanelDatabase();
        ...
        this.panel3.add(this.panelDatabase, PANEL_DATABASE);
        ...
        panel4 = new JPanel();
        panel4.setLayout(new MigLayout("inset 0 0 0 0", "[min!][min!][min!][min!][min!]", "[min!]"));
        ...
        // add button to panel4
        this.btnAddCompany = new JButton("Add Company");
        this.btnAddCompany.setFont(Configuration.FontNormal);
        panel4.add(this.btnAddCompany, "cell 2 0");
    ...
    private void prefillPanel() {
        ...
        this.lblLabel1.setText(Configuration.languageResources.getString("panelsuperuser.lblLable1"));
        this.lblTypeAccountView.setText(Configuration.languageResources.getString("panelsuperuser.lblTypeAccountView") + ":");
        this.typeAccountView.setModel(accountView);
        this.lblDateStart.setText(Configuration.languageResources.getString("panelsuperuser.lblDateStart") + ":");
        ((TitledBorder)this.panel2.getBorder()).setTitle(Configuration.languageResources.getString("panelsuperuser.panel2"));
    }
    ...
    private void selectTreeRow() {
        ...
        if (node.getLevel() == 0) {
            ...
            cl.show(this.panel3, PANEL_DATABASE);            
