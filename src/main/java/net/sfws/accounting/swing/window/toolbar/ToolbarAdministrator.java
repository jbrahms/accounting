 ...
 *
 */
public class ToolbarAdministrator extends JToolBar implements Serializable {
     ...
     * @param arg0
     */
    public ToolbarAdministrator(int arg0) {
     ...
     * @param arg0
     */
    public ToolbarAdministrator(String arg0) {
     ...
     * @param arg0
     */
    public ToolbarAdministrator(String arg0, FrmMainWindow parent) {
     ...
     * @param arg1
     */
    public ToolbarAdministrator(String arg0, int arg1) {
    ...
    private void initToolbar() {
        ...
        JButton btnTbAdministation = new JButton("Admin");
        btnTbAdministation.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                parent.mnuViewAdministrationActionPerformed();
            }
        });
        btnTbAdministation.setIconTextGap(0);
        btnTbAdministation.setIcon(new ImageIcon(ToolbarAdministrator.class.getResource("/net/sfws/accounting/res/toolbar-admin.gif")));
        btnTbAdministation.setHorizontalTextPosition(SwingConstants.CENTER);
        btnTbAdministation.setVerticalTextPosition(SwingConstants.BOTTOM);
        btnTbAdministation.setMinimumSize(new Dimension(55, 55));
        btnTbAdministation.setMaximumSize(new Dimension(55, 55));
        btnTbAdministation.setPreferredSize(new Dimension(55, 55));
        btnTbAdministation.setSize(new Dimension(55, 55));
        this.add(btnTbAdministation);
        
        JButton btnTbAccounting = new JButton("Accounting");
        btnTbAccounting.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                parent.mnuViewAccountingActionPerformed();
            }
        });
        btnTbAccounting.setIconTextGap(0);
        btnTbAccounting.setIcon(new ImageIcon(ToolbarAdministrator.class.getResource("/net/sfws/accounting/res/toolbar-admin.gif")));
        btnTbAccounting.setHorizontalTextPosition(SwingConstants.CENTER);
        btnTbAccounting.setVerticalTextPosition(SwingConstants.BOTTOM);
        btnTbAccounting.setMinimumSize(new Dimension(55, 55));
        btnTbAccounting.setMaximumSize(new Dimension(55, 55));
        btnTbAccounting.setPreferredSize(new Dimension(55, 55));
        btnTbAccounting.setSize(new Dimension(55, 55));
        this.add(btnTbAccounting);
