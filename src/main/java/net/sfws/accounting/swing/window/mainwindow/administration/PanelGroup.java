...
import net.sfws.accounting.swing.window.DlgGroup;
...
public class PanelGroup extends JPanel {
     ...
     * Create the panel.
     */
    public PanelGroup(Object parent) {
    ...
    private void initPanel() {
        ...
        // set border
        setBorder(new TitledBorder(null, "Group", TitledBorder.LEADING, TitledBorder.TOP, Configuration.FontNormalBold, null));
