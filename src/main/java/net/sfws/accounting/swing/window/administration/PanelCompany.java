...
public class PanelCompany extends JPanel {
     ...
     * Create the panel.
     */
    public PanelCompany(int option) {
    ...
    private void initPanel(int option) {
        ...
        this.lblLabel1.setIcon(new ImageIcon(PanelCompany.class.getResource("/net/sfws/accounting/res/icon-bank.gif")));
        ...
        this.lblCompanyId = new JLabel("Company-Id:");
        this.lblCompanyId.setFont(Configuration.FontNormal);
        this.panel1.add(this.lblCompanyId, "cell 0 0");
        
        this.companyId = new JTextField();
        this.companyId.setFont(Configuration.FontNormal);
        this.companyId.setColumns(10);
        this.panel1.add(this.companyId, "cell 1 0 3 1");
        ...
        this.decription = new JTextField();
        this.decription.setFont(Configuration.FontNormal);
        this.panel1.add(this.decription, "cell 1 2 3 1, growx");
